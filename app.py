...
st.write("Generate **tailored UK primary school lesson plans** in seconds. Fill in the details below and let AI do the rest!")
...
if submitted:
    with st.spinner("✨ Creating your lesson plan..."):
        prompt = f"""
Create a detailed UK primary school lesson plan with clear sections, for this info:
...
Provide it in a readable format with these sections:
- Lesson Title
- Learning Outcomes
- Starter Activity
- Main Activity
...
Do NOT include anything the teacher wouldn't be able to do with standard classroom resources.
Format clearly with headings and line breaks, no markdown symbols.
"""
        try:
